...
160 PUT SPRITE 0,(X(0)\16,Y(0)\16-1),4,(P(0)+R(0)*2)
170 PUT SPRITE 1,(X(0)\16,Y(0)\16-1),11,(P(0)+R(0)*2)+1:RETURN

200 ' ***** PLAYER SPRITE UPDATE *****
210 X=X(0)\16:Y=Y(0)\16-1:P=(P(0)*4)+(R(0)*8):AD=BASE(8)
220 VPOKE AD,Y:VPOKE AD+1,X:VPOKE AD+2,P
230 VPOKE AD+4,Y:VPOKE AD+5,X:VPOKE AD+6,P+4:RETURN

250 ' ***** OTHER SPRITE PUT *****
260 PUT SPRITE N+1,(X(N)\16,Y(N)\16-1),C(N),P(N):RETURN

270 ' ***** OTHER SPRITE UPDATE *****
280 X=X(N)\16:Y=Y(N)\16-1:P=(P(N)+R(N))*4:AD=BASE(8)+((N+1)*4)
...
1130 X=(INT(RND(1)*22)+4)*8*16:Y=0:TX=(INT(RND(1)*22)+4)*8*16:TY=(INT(RND(1)*3)+2)*8*16+1:SP=1:GOSUB 2000
...
8600 ' ***** MISS *****
8610 PLAY "T120L16O4V12AV6AV12EF#V6F#V12O3BC#V6C#O5V12CO2AV6A","T120L16O5V12AV6AR16V12F#V6F#R16O4V12C#V6C#R16O3V12AV6A"
8620 IF PLAY(0) THEN 8620 ELSE RETURN
