...
280 X=X(N)\16:Y=Y(N)\16:P=(P(N)+R(N))*4:AD=BASE(8)+((N+1)*4)
290 VPOKE AD,Y:VPOKE AD+1,X:VPOKE AD+2,P:RETURN

300 ' ***** MAIN ROUTINE *****
310 ON GS GOSUB 5000,3000,400,3500,4000,1600,1700
320 GOTO 300

400 ' ***** GAME MAIN *****
410 ON BF+1 GOSUB 500,600
420 A=&H1800+(X(0)\128)+1+(Y(0)\128)*32:IF VPEEK(A)<>32 OR VPEEK(A-32)<>32 THEN GS=6:RETURN
430 FOR I=4 TO 7:IF F(I) AND ABS(X(I)-X(0))<192 AND ABS(Y(I)-Y(0))<192 THEN GS=6:NEXT I ELSE NEXT I
440 IF SF THEN GOSUB 800
450 GOSUB 1000
460 A=USR2(0):RETURN
...
820 FOR I=3 TO 5
830 IF ABS(X(N)-X(I))<192 AND ABS(Y(N)-Y(I))<192 THEN SC=SC+50+(F(I)=2)*50:PLAY "T255L32O5V12CGEB":F(I)=0:Y(I)=3088:SWAP N,I:GOSUB 250:SWAP N,I
...
1170 IF F(N) AND INT(RND(1)*5)=0 THEN LOCATE X(N)\128+INT(RND(1)*2),Y(N)\128+1:PRINT "n";
1180 RETURN
...
1540 Y=2304:TY=2304:GOSUB 2000:GOSUB 250:RETURN

1550 GOSUB 2100:IF TF THEN F(N)=0:Y(N)=3088:GOSUB 250:RETURN
1560 R(N)=R(N) XOR 1:GOSUB 270:RETURN

1600 ' ***** MISS *****
1610 GOSUB 8600:JF=1:P(0)=8:R(0)=0:GOSUB 150
1620 Y(0)=Y(0)-JY(JF):GOSUB 200:JF=JF-(JF<7):IF Y(0)<3072 THEN 1620
1630 IF LF=0 THEN GS=7:RETURN
1640 LF=LF-1:GOSUB 2400:GOSUB 2200:GOSUB 2300:GOSUB 5300:GS=3:RETURN

1700 ' ***** GAME OVER *****
1710 GOSUB 2200:GOSUB 2300
1720 LOCATE 11,9:PRINT "GAME OVER";:GOSUB 8700
1730 GS=1:RETURN
...
2030 WX(N)=(DX/A)*(8*SP)*16:WY(N)=(DY/A)*(8*SP)*16
2040 RETURN
...
2310 FOR I=0 TO 19:LOCATE 4,I:PRINT SPACE$(24);:NEXT I:RETURN
...
3000 ' ***** ROUND START *****
3010 CLS:GOSUB 8000:X(0)=0:Y(0)=2304:F(0)=1:P(0)=0:R(0)=1:GOSUB 150
3020 P(0)=0:X1=0:X2=15:GOSUB 5400:LOCATE 15,16:PRINT "!!";:P(0)=4:GOSUB 200
3030 GOSUB 6020:LOCATE 15,16:PRINT "  ";:P(0)=0:GOSUB 200
3040 LOCATE 9,8:PRINT USING "ROUND # START";RD
3050 GOSUB 8750:GOSUB 2300:GOSUB 5300:GS=3:RETURN

3500 ' ***** ROUND CLEAR *****
3510 GOSUB 6030:X1=X(0)/128:X2=30:P(0)=0:GOSUB 5400
3520 LOCATE 9,8:PRINT USING "ROUND # CLEAR";RD
3530 LOCATE 10,10:PRINT USING "BONUS #####";RD*1000
3540 GOSUB 8800:SC=SC+RD*1000:RD=RD+1:GS=2:RETURN

4000 ' ***** ALL ROUND CLEAR *****
4010 CLS:GOSUB 8000:LOCATE 8,5:PRINT "CONGRATULATIONS!!";
4020 GOSUB 8900:SC=SC+10000
4030 GS=1:RETURN

5000 ' ***** TITLE *****
5010 CLS:GOSUB 8000
5020 FOR I=0 TO 6:VPOKE &H184B+I,161+I:VPOKE &H186B+I,193+I:NEXT I
5030 FOR I=0 TO 6:VPOKE &H188E+I,168+I:VPOKE &H18AE+I,200+I:NEXT I
...
5120 IF INT(RND(1)*8)=0 THEN F(N)=F(N) XOR 1:LOCATE X(N),Y(N):PRINT MID$(" m",F(N)+1,1);
5130 N=N MOD 5+1:IF STRIG(0)+STRIG(1)=0 THEN 5120
5140 FOR I=12 TO 18:LOCATE 7,I:PRINT "                   ";:NEXT I
5150 X1=3:X2=26:GOSUB 5400:GOSUB 6030:X1=26:X2=30:GOSUB 5400:Y(0)=3088:GOSUB 150

5160 ' ----- GAME GLOBAL INIT -----
5170 GOSUB 2200:RD=1:LF=2:SC=0:GS=2:RETURN

5300 ' ----- GAME INIT -----
5310 C=1:SF=0:BF=0:JF=0:JS=0:FOR I=0 TO 8:F(I)=0:NEXT I
5320 X(0)=15*128:Y(0)=18*128:P(0)=0:F(0)=1:GOSUB 150
5330 X(1)=15*128:Y(1)=10*128:P(1)=10:F(1)=1:C(1)=14:N=1:GOSUB 250
5340 RETURN

5400 ' ----- SHONES MOVE(DEMO) ----
5410 FOR I=X1 TO X2:X(0)=I*128:R(0)=R(0) XOR 1:GOSUB 200:FOR W=0 TO 39:NEXT W:NEXT I
5420 RETURN
...
8200 LOCATE 0,22:PRINT " SCORE        STAGE      LEFT";:GOSUB 2400
8210 IF GS=1 THEN RETURN
8230 LOCATE 0,15:PRINT "hh";
8240 LOCATE 0,16:PRINT "hhh";
8250 LOCATE 0,17:PRINT "ooh"; :'of'
8260 LOCATE 0,18:PRINT "  h"; :'fo' 
8270 LOCATE 0,19:PRINT "  h"; :'oo'
8280 RETURN
...
8750 ' ----- ROUND START -----
8760 PLAY "T110L16O4V12FEDC4EF#4F#8V10F#V8F#R2","T110L16O2F#A#O3DG4EF#4F#8V10F#V8F#R2"
8770 IF PLAY(0) THEN 8770 ELSE RETURN

8800 ' ----- ROUND CLEAR -----
8810 PLAY "T110L16O5V12F#V10F#V8F#V12DF#R8.","T110L16O5V12DV10DV8DV12O4A#O5DR8.","T110L16O4V12F#R8O3A#O4F#O3A#O4DF#"
8820 PLAY "G#V10G#V8GV12EG#R8.","EV10EV8EV12CER8.","G#R8CG#CEG#"
8830 PLAY "AV10AV8AA12EA8V10AV8AR1","EV10EV8EV12CE8V10EV8ER1","AV10AV8AV12CA8V10AV8AR1"
