...
300 ' ***** MAIN ROUTINE *****
310 ON GS GOSUB 5000,4500,400,1600
320 GOTO 300

400 ' ***** GAME MAIN *****
410 A=&H1800+(X(0)\16\8)+1+(Y(0)\16\8)*32:IF VPEEK(A)<>32 OR VPEEK(A-32)<>32 THEN GS=4:RETURN
420 FOR I=4 TO 7:IF F(I) AND ABS(X(I)-X(0))<256 AND ABS(Y(I)-Y(0))<256 THEN GS=4:NEXT I ELSE NEXT I
...
540 X(0)=X(0)+VX(S):IF X(0)<512 OR X(0)>3320 THEN X(0)=X(0)-VX(S)
...
1130 X=(INT(RND(1)*22)+4)*8*16:Y=1:TX=(INT(RND(1)*22)+4)*8*16:TY=((INT(RND(1)*3)+2)*8*16):SP=1:GOSUB 2000
...
1210 TX=(INT(RND(1)*22)+4)*8*16:TY=(INT(RND(1)*5))*8*16+1:SP=1:GOSUB 2000:RETURN
...
4520 FOR I=0 TO 10:PUT SPRITE I,(0,192),0,0:NEXT I
4530 X(0)=15*8*16:Y(0)=18*8*16:P(0)=0:F(0)=1:GOSUB 150
4540 X(1)=15*8*16:Y(1)=10*8*16:P(1)=10:F(1)=1:C(1)=14:N=1:GOSUB 250
4550 FOR I=3 TO 6:F(I)=0:NEXT I
4560 GS=3:C=1:GOSUB 8000:RETURN
...
5110 GOSUB 8500:LOCATE 11,12:PRINT "PUSH BUTTON";
...
5180 GS=2:RETURN
5200 ' ----- SHONES MOVE ----
5210 FOR I=X1 TO X2:X(0)=I*8*16:R(0)=R(0) XOR 1:GOSUB 200:FOR W=0 TO 49:NEXT W:NEXT I
5300 ' ----- EYES -----
