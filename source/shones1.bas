...
400 ' ***** GAME MAIN *****
410 A=&H1800+(X(0)\128)+1+(Y(0)\128)*32:IF VPEEK(A)<>32 OR VPEEK(A-32)<>32 THEN GS=6:RETURN
420 FOR I=4 TO 7:IF F(I) AND ABS(X(I)-X(0))<256 AND ABS(Y(I)-Y(0))<256 THEN GS=6:NEXT I ELSE NEXT I
430 ON BF+1 GOSUB 500,600
...
820 FOR I=3 TO 5
830 IF ABS(X(N)-X(I))<128 AND ABS(Y(N)-Y(I))<128 THEN SC=SC+50+(F(I)=2)*50:PLAY "T255L32O5V12CGEB":F(I)=0:Y(I)=3088:SWAP N,I:GOSUB 250:SWAP N,I
...
3000 ' ***** ROUND START *****
3010 CLS:GOSUB 8000:GOSUB 5300:X(0)=0:Y(0)=2304:F(0)=1:P(0)=0:R(0)=1:GOSUB 150
...
3050 GOSUB 2300:GOSUB 5300:GS=3:RETURN
