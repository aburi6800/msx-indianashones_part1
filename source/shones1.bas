...
430 X=X(0)+128:Y=Y(0):FOR I=4 TO 7:IF F(I) AND ABS(X(I)-X)<192 AND ABS(Y(I)-Y)<192 THEN GS=6:NEXT I ELSE NEXT I
...
1720 Y(0)=Y(0)-JY(JF):GOSUB 200:JF=JF-(JF<7):IF Y(0)<3072 THEN 1720
1730 IF LF=0 THEN GS=7:RETURN
1740 LF=LF-1:GOSUB 2400:GOSUB 2200:GOSUB 2300:GOSUB 5300:GS=3:RETURN
...
2440 IF GS=3 THEN LOCATE 14,0:PRINT "ppp";
2450 RETURN

3000 ' ***** ROUND START *****
3010 CLS:GOSUB 8000:X(0)=0:Y(0)=2304:F(0)=1:P(0)=0:R(0)=1:GOSUB 150
3020 P(0)=0:X1=0:X2=15:GOSUB 5400
3030 N=1:X(1)=X(0):Y(1)=Y(0)-384:C(1)=15:P(1)=18:GOSUB 250:P(0)=4:GOSUB 200:GOSUB 6020
3040 Y(1)=3088:GOSUB 270:P(0)=0:GOSUB 200
3050 LOCATE 9,8:PRINT USING "ROUND # START";RD
3060 GOSUB 8750:GOSUB 2300:GOSUB 5300:GS=3:RETURN
