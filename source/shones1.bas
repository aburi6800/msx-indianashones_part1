...
430 X=X(0)\16:Y=Y(0)\16:FOR I=4 TO 7:IF F(I) AND ABS(X(I)\16-X)<16 AND ABS(Y(I)\16-Y)<16 THEN LOCATE 0,22:PRINT I,X(I);Y(I),X;Y:GS=6
440 NEXT I
...
820 SF=0:X=X(1)\16-4:Y=Y(1)\16-4:FOR I=3 TO 5:IF ABS(X(I)\16-X)<16 AND ABS(Y(I)\16-Y)<16 THEN GOSUB 850
...
1550 R(N)=R(N) XOR 1:GOSUB 2100:IF TF THEN F(N)=0:Y(N)=3200:GOSUB 250:RETURN
1560 RETURN
