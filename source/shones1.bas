...
430 FOR I=4 TO 7:IF F(I) AND ABS(X(I)-X(0))<256 AND ABS(Y(I)-Y(0))<256 THEN GS=6:NEXT I ELSE NEXT I
...
8750 ' ***** ROUND START *****
8760 PLAY "T110L16O4V12FEDC4ED#4D#8V10D#V8D#R2","T110L16O2F#A#O3DG4ED#4D#8V10D#V8D#R2"
